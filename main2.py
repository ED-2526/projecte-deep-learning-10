...
if __name__ == "__main__":
    ...
    # Paràmetres compartits per totes les execucions
    BASE = dict(
        epochs=20,
        patience=5,
        finetune_epochs=15,
    ...
    # Resultats previs: fase 2 perjudica ResNet (backbone potent, dataset petit).
    # EfficientNet sí que es beneficia del fine-tuning.
    EXPERIMENTS = [
        # --- ResNet50 ---
        {**BASE, "architecture": "resnet50", "transform_mode": "standard",  "finetune": False},
        {**BASE, "architecture": "resnet50", "transform_mode": "pad",       "finetune": False},
        {**BASE, "architecture": "resnet50", "transform_mode": "augmented", "finetune": False},
        # --- ResNet18 ---
        {**BASE, "architecture": "resnet18", "transform_mode": "standard",  "finetune": False},
        {**BASE, "architecture": "resnet18", "transform_mode": "pad",       "finetune": False},
        {**BASE, "architecture": "resnet18", "transform_mode": "augmented", "finetune": False},
        # --- EfficientNet-B0 ---
        {**BASE, "architecture": "efficientnet_b0", "transform_mode": "standard",  "finetune": True},
        {**BASE, "architecture": "efficientnet_b0", "transform_mode": "pad",       "finetune": True},
        {**BASE, "architecture": "efficientnet_b0", "transform_mode": "augmented", "finetune": True},
    ]

    for cfg in EXPERIMENTS:
        print(f"\n{'='*60}")
        print(f"Executant: {_run_name(cfg)}")
        print(f"{'='*60}")
        model_pipeline(cfg)
